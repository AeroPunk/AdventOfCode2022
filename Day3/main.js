...
RDZPZBLmPVWDVrQtnzSTmgTwmTSg`.split(/\n/);
...
const findCommon = (seg1, seg2) => {
	for (let i in seg1) {
		if (seg2.includes(seg1[i])) {
			return seg1[i];
		}
	}
};
...
input.forEach((rucksack) => {
	let [seg1, seg2] = splitRucksack(rucksack);
	let commonChar = findCommon(seg1, seg2);
